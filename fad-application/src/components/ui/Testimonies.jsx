                ...
                <CarouselContent>
                    ...
                    <div className='p-1'>
                        <Card className="flex justify-center border-none">
                            <CardContent className="flex flex-col bg-cardbg aspect-square justify-between p-6 xl:h-[32rem] xl:text-base text-2xs h-80 rounded-xl space-y-5">
                                <div>
                                ...
                                <div>
                                    <span className="font-[300]">Patricia Serrano<br></br></span>
                    ...
                    <div className='p-1'>
                        <Card className="flex justify-center border-none">
                            <CardContent className="flex flex-col bg-cardbg aspect-square justify-between p-6 xl:h-[32rem] xl:text-base text-xs h-80 rounded-xl space-y-5">
                                <div>
                                ...
                                <div>
                                    <span className="font-[300]">Poula Andrei Sitjar<br></br></span>
                                    <span>Painting</span>
                                </div>
                            </CardContent>
                        </Card>
                    ...
                    <div className='p-1'>
                        <Card className="flex justify-center border-none">
                            <CardContent className="flex flex-col bg-cardbg aspect-square justify-between p-6 xl:h-[32rem] xl:text-base text-2xs h-80 rounded-xl space-y-5">
                                ...
                                <div>
                                    <span className="font-[300]">Heraldo G. Corpus<br></br></span>
                    ...
                    <div className='p-1'>
                        <Card className="flex justify-center border-none">
                            <CardContent className="flex flex-col bg-cardbg aspect-square justify-between p-6 xl:h-[32rem] xl:text-base text-xs rounded-xl space-y-5">
                                <div>
                                ...
                                <div>
                                    <span className="font-[300]">John Cris Marquez<br></br></span>
